# Blockhouse Quant Research Trial: OFI Feature Construction

This project implements several Order Flow Imbalance (OFI) features based on the paper  
**"Cross-Impact of Order Flow Imbalance in Equity Markets"** as part of a quant research internship task.
...
* `Integrated OFI`: Smoothed cumulative version over time
* `Cross-Asset OFI`: Incorporates impact across different assets
